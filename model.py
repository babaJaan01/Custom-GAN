...
genVars = tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.GLOBAL_VARIABLES, scope = "GAN/Generator") # variable for generator
discVars = tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.GLOBAL_VARIABLES, scope = "GAN/Discriminator") # variable for discrim

genStep = tf.compat.v1.train.RMSPropOptimizer(learning_rate = 0.001).minimize(genLoss, var_list = genVars)  # optimizer for generator
discStep = tf.compat.v1.train.RMSPropOptimizer(learning_rate = 0.001).minimize(discLoss, var_list = discVars)  # optimizer for discrim
